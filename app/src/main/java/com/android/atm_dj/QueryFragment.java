...
public class QueryFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        TextView textView = view.findViewById(R.id.tv_query);
        MenusActivity menusActivity = (MenusActivity) getActivity();
        user_database us_read = new user_database(menusActivity);
        SQLiteDatabase sqLiteDatabase =us_read.getReadableDatabase();
        List<userInfo> list = us_read.querydata(sqLiteDatabase);
        Bundle bundle = getArguments();
        String str = bundle.getString("key_id");
        int id = Integer.parseInt(str);
        textView.setText("您的余额为 "+list.get(id).getUsermoney()+" 元");
        return view;
    }
